...
#include "../../colorization/drawingwidget.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_DrawingWidget_t, stringdata) + ofs \
...
void *DrawingWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DrawingWidget.stringdata))
